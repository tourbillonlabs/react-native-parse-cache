      ...
      return new Promise(function (resolve, reject) {
        cache.get(key, function (err, cachedResults) {
          ...
          if (cachedResults != null) {
            ...
            cachedResults = Array.isArray(cachedResults) ? cachedResults.map(inflateModel(Parse.Object.extend(model))) : inflateModel(Parse.Object.extend(model))(cachedResults);
            return resolve(cachedResults);
          }
...
module.exports = function init(Parse, cacheName) {
